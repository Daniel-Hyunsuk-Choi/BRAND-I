...
| 홈 화면 | 게시물 상세 |
| -------- | -------- |
| <img src="imgs/1_home.png" width="300"> | <img src="imgs/1_1_home_detail.png" width="300"> |

### 2. 개인 프로필 화면
- 개인 프로필 섹션에서는 게시 글의 숫자에 따라 뱃지가 주어진다. 또한 프로필에서 설정한 관심 카테고리가 보여진다
- 프로필 페이지의 핵심은 참여 중인 방의 리스트! 방에서 피드 작성용 챌린지가 시작되고, 이를 다이어리에 기록하는 방식
- 피드에는 프라이빗 포스트인지 퍼블릭 포스트인지가 나오고, 챌린지를 진행한 방이 아래 작게 나온다
- 본인의 게시물 중, private 는 자물쇠가 하이라이트 되어 표현된다

<img src="imgs/2_profile.png" width="300">
...
<img src="imgs/3_challenges.png" width="300">
...
| 챌린지 방 화면 | 달력 표현 | 챌린지 상세보기 |
| -------- | -------- | -------- |
| <img src="imgs/4_challenge_detail.png" width="300"> | <img src="imgs/4_calendar.png" width="300"> | <img src="imgs/4_this_week_challenge.png" width="300"> |